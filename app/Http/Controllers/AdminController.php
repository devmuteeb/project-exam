...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('admin.dashboard', ['student' => $studentCount, 'exam' => $exam_count, 'admin' => $admin_count, 'categories' => $categories]);
    ...
    public function manage_students()
    {
        ...
        $data['students'] = Student_Exam::select([
            'student_exams.*', 'students.name',
            'exam_masters.title as ex_name', 'exam_masters.exam_date'
        ])
    ...
    {
        $std = Student_Exam::where('id', $id)->get()->first();
        ...
        $std1 = Student_Exam::where('id', $id)->get()->first();
    ...
    public function delete_registered_students($id)
    {
        ...
        $std = Student::where('id', $id)->get()->first();
        $std->delete();
    ...
    public function admin_view_result($id)
    {
        ...
        $std_exam = Student_Exam::where('id', $id)->get()->first();

        $data['student_info'] = Student::where('id', $std_exam->student_id)->get()->first();

        $data['exam_info'] = exam_master::where('id', $std_exam->exam_id)->get()->first();

        $data['result_info'] = Result::where('exam_id', $std_exam->exam_id)->where('student_id', $std_exam->student_id)->get()->first();
